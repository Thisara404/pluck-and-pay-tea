            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-xl">LKR {payment.totalAmount.toFixed(2)}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Average Per Plucker</p>
                  <p className="font-medium">LKR {(payment.totalAmount / payment.pluckerCount).toFixed(2)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                    ...
                    <div>
                      ...
                      <div className="pl-6 mt-2 space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">LKR {125.50}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Robert Smith</span>
                          <span className="font-medium">LKR {118.75}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>James Brown</span>
                          <span className="font-medium">LKR {112.20}</span>
                        </div>
                      </div>
                    </div>
                  </div>
